...
export default function Home() {
  ...
  const content = {
    ...
    el: {
      metaDescription:
        "Ακολούθησε τη Sol the Cat σε 50+ πόλεις, από την Αθήνα μέχρι την Πέτρα. Διάβασε ταξιδιωτικές ιστορίες, παίξε 12 δωρεάν mini-games και νίκα την καθημερινή πρόκληση.",
      quoteTitle:
        mode === "fortune"
